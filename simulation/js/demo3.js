...
document.getElementById("check11").addEventListener("click", function () {
        ...
        if ( is_connected_1_4&&is_connected_2_5 && !unallowed_connection_present &&  $("#drag6").parents("#div6").length == 1 && ($("#drag0").parents("#div0").length == 1 || $("#drag0").parents("#div9").length == 1) && ($("#drag9").parents("#div0").length == 1 || $("#drag9").parents("#div9").length == 1)
       && $("#drag4").parents("#div4").length == 1) {
