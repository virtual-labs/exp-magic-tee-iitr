...
function vswr1(){
  ...
  Swal.fire({
   ...
   width:'480px',
    ...
    text:'Click on VSMR Meter button only when you observe Square waveform in CRO.',     
    icon:'info',
    });
   ...
   Swal.fire({
    ...
    Swal.fire({
     ...
     width:'480px',
      ...
      text:'Move the knob of reflector voltage for some values.',     
      icon:'warning',
      });
    ...
    Swal.fire({
     ...
     width:'480px',
      ...
      title:'P1 value missing.',
      text:'To get the value of P1, click on VSMR Meter button.',     
      icon:'warning',
      });
     
  }
  else if(((b==239 || b==219) && (v1==23)) || ((b==180) && v1==40)){
 var c = (v1)
...
Swal.fire({
 ...
 width:'480px',
  ...
  html:'Do you want to print this page?',
  icon:'info',
}).then((result) => {
 ...
 print();
    ...
    Swal.fire({
     ...
     width:'480px',
      ...
      html:'Click on <b style="color:blue">Next</b> button for P2.',     
      icon:'info',
  }).then((result) => {
    if(result.isConfirmed)
      {
...
document.getElementById("vswr").disabled= true;
