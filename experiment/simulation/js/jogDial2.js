...
function validate() {
  ...
  Swal.fire({
   ...
   width:'480px',
    ...
    title:'Missing',
    text:'Enter the value for P2.',     
    icon:'warning',
    });
  return;
}
else if(((b==239 || b==219) && (v2==48 )) || ((b==180) && (v2==69))){
document.getElementById('two').innerText = (v2)
var e =  (v2)
localStorage.setItem("V2",e)
Swal.fire({
  backdrop:false,
 target: '#rom',
 position:'center',
 ...
 print();
    ...
    Swal.fire({
     ...
     width:'480px',
      ...
      html:'Click on <b style="color:blue">Next</b> button for P3.',     
      icon:'info',
  }).then((result) => {
    if(result.isConfirmed)
      {
