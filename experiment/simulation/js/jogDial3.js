...
(function (window, undefined) {
  ...
  function myFunction() {
    ...
    if(t==='Reflector Voltage'){
      ...
      var viewModel = {
        testValue2: ko.observable(localStorage.getItem("Beam"))
    };
    }
    else{
      document.getElementById('name').innerText='Reflector Voltage' 
      var viewModel = {
        testValue2: ko.observable(localStorage.getItem("Reflector"))
    };
    
    c= localStorage.getItem("Reflector")
            if(c==239 || c==219){
              d=25
            }
            else if (c==180){
            ...
            document.getElementById("powerr").innerText=d
    }
...
var v3=0
function validate() {
   v3 = document.getElementById('V4').value;
   var text = document.getElementById('name').innerText;
   if(text == "Beam Voltage" )
  {
   Swal.fire({
     backdrop:false,
    target: '#rom',
    ...
    width:'480px',
     ...
     text:'Toggle the switch button and note down the value for P3.',     
     icon:'warning',
     });
  }
  else if(v3==0){
    Swal.fire({
     ...
     width:'480px',
      ...
      title:'Missing',
      text:'Enter the value for P3.',     
      icon:'warning',
      });
   }
 else if(((b==239 || b==219) && v3==25) || ((b==180 ) && (v3==44))){
document.getElementById('three').innerText = v3;
Swal.fire({
  backdrop:false,
 target: '#rom',
 position:'center',
 width:'480px',
  ...
  html:'Click on <b style="color:blue">Calculate</b> button to calculate Coupling Coefficient and Isolation.',     
  icon:'info',
  });
document.getElementById("ccccc").disabled=false;
document.getElementById("add").disabled=true;
    ...
    Swal.fire({
     ...
     width:'480px',
      ...
      title:'Oops....', 
      text:'Wrong value. Enter it again.',    
      icon:'error',
      });
